...
export const exchangePublicToken = async ({ publicToken, user }: exchangePublicTokenProps) => {
  try {
    ...
    // Get acount information from Plaid using the access token
    ...
    // Create a funding source URL for the account using the Dwolla customr ID, processor token, and bank name
